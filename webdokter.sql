...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 21 Jul 2020 pada 10.57
...
CREATE TABLE `datadokter` (
  `kddokter` char(3) NOT NULL,
  `namadokter` varchar(35) NOT NULL,
  `kdspesialis` char(3) NOT NULL,
...
INSERT INTO `datadokter` (`kddokter`, `namadokter`, `kdspesialis`, `telepon`, `jk`) VALUES
('D01', 'Dr. Boi Trimoyo', 'UMM', '081111111111', 'P'),
('D02', 'Dr. Irfan Nurhuddin', 'DLM', '082222222222', 'P'),
('D03', 'Dr. Muswanto', 'BDH', '083333333333', 'P'),
('D04', 'Dr. Umar', 'JTG', '084444444444', 'P'),
('D05', 'Dr. Ibrahim', 'KDG', '085555555555', 'P'),
('D06', 'Dr. Aji', 'SRF', '086666666666', 'P'),
('D07', 'Dr. Ridwan', 'MAT', '087777777777', 'P'),
('D08', 'Dr. Fajar', 'ANK', '088888888888', 'P'),
('D09', 'Dr. Mory', 'UMM', '089999999999', 'P'),
('D10', 'Dr. Serly', 'BDH', '080000000000', 'W'),
('D11', 'Dr. Chandra', 'UMM', '081010101010', 'P'),
('D12', 'Dr. Bayhaqi', 'BDH', '082020202020', 'P'),
('D13', 'Dr. Rina', 'ANK', '083030303030', 'W'),
...
('D18', 'Dr. Neneng', 'KDG', '088080808080', 'W');
...
INSERT INTO `datajadwal` (`namadokter`, `hari`, `jammulai`, `jamselesai`) VALUES
('Dr. Boi Trimoyo', 'Senin', '08:15:00', '12:15:00'),
('Dr. Irfan Nurhuddin', 'Minggu', '09:00:00', '14:00:00'),
('Dr. Muswanto', 'Selasa', '08:15:00', '16:00:00'),
('Dr. Umar', 'Selasa', '08:15:00', '20:00:00'),
('Dr. Ibrahim', 'Selasa', '08:15:00', '14:00:00'),
('Dr. Aji', 'Kamis', '08:15:00', '14:00:00'),
('Dr. Ridwan', 'Jumat', '08:15:00', '11:30:00'),
('Dr. Fajar', 'Selasa', '16:00:00', '21:00:00'),
('Dr. Mory', 'Senin', '12:15:00', '16:30:00'),
('Dr. Serly', 'Sabtu', '08:15:00', '14:00:00'),
('Dr. Chandra', 'Senin', '17:30:00', '20:00:00'),
('Dr. Bayhaqi', 'Rabu', '08:15:00', '14:00:00'),
('Dr. Rina', 'Rabu', '08:15:00', '12:00:00'),
('Dr. Agus', 'Rabu', '08:15:00', '14:00:00'),
('Dr. Andin', 'Selasa', '14:00:00', '20:00:00'),
('Dr. Labala', 'Rabu', '14:00:00', '21:00:00');

-- --------------------------------------------------------

--
-- Struktur dari tabel `datajaga`
--

CREATE TABLE `datajaga` (
  `kddokter` char(3) NOT NULL,
  `hari` varchar(15) NOT NULL,
  `jammulai` time NOT NULL,
  `jamselesai` time NOT NULL
...
--
-- Struktur dari tabel `datalihatdokter`
--

CREATE TABLE `datalihatdokter` (
  `kdspesialis` char(3) NOT NULL,
  `namadokter` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `datalihatdokter`
--

INSERT INTO `datalihatdokter` (`kdspesialis`, `namadokter`) VALUES
('UMM', 'Dr. Agus'),
('SRF', 'Dr. Aji'),
('KDG', 'Dr. Andin'),
('BDH', 'Dr. Bayhaqi'),
...
--
-- Struktur dari tabel `dataspesialis`
--

CREATE TABLE `dataspesialis` (
  `kdspesialis` char(3) NOT NULL,
  `spesialis` varchar(35) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data untuk tabel `dataspesialis`
--

INSERT INTO `dataspesialis` (`kdspesialis`, `spesialis`) VALUES
('ANK', 'Anak'),
('BDH', 'Bedah'),
('DLM', 'Penyakit Dalam'),
('GIG', 'Gigi'),
...
--
-- Indeks untuk tabel `datalihatdokter`
--
ALTER TABLE `datalihatdokter`
  ADD PRIMARY KEY (`namadokter`);

--
-- Indeks untuk tabel `dataspesialis`
--
ALTER TABLE `dataspesialis`
  ADD PRIMARY KEY (`kdspesialis`);
